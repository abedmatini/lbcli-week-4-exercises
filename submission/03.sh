...
# Create the raw transaction with the payment output AND the hex-encoded data output
bitcoin-cli -regtest createrawtransaction "[{\"txid\":\"$txid\",\"vout\":0}, {\"txid\":\"$txid\",\"vout\":1}]" "[{\"2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP\":0.2}, {\"data\":\"627472757374206275696c6465722032303236\"}]"
